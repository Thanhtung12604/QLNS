        ...
        <div class="row g-2 align-items-center">
            <div class="col">
                <div class="text-muted mb-1">
                    <a href="<?= BASE_URL ?>position">Chức danh</a> / Thêm mới
                </div>
                <h2 class="page-title">Thêm chức danh</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="page-body">
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form method="POST" action="<?= BASE_URL ?>position/add">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="ma_chuc_danh" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label required">Tên chức danh</label>
                                <input type="text" name="ten_chuc_danh" class="form-control" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="muc_luong_co_ban" class="form-control" step="100000" value="0">
                            </div>
                        </div>
